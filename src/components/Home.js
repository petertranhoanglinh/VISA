            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div className="position-relative mb-4"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
                  <canvas id="visitors-chart" height={200} width={764} style={{display: 'block', width: '764px', height: '200px'}} className="chartjs-render-monitor" />
                </div>
          ...
          <div className="col-lg-6">
            <div className="card">
              ...
              <div className="card-body">
                ...
                {/* /.d-flex */}
                <div className="position-relative mb-4"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
                  <canvas id="sales-chart" height={200} style={{display: 'block', width: '764px', height: '200px'}} width={764} className="chartjs-render-monitor" />
                </div>
                <div className="d-flex flex-row justify-content-end">
                  <span className="mr-2">
